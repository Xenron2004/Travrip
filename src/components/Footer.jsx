...
const Footer = () => {
  return (
    ...
    <div className="flex flex-wrap max-w-[1280px] gap-8 w-11/12 py-8 px-2 border-b border-dashed justify-between">
      ...
      <div className="flex flex-col gap-2 ">
        ...
        <div className="font-plusjakarta font-normal text-[#e8e9eb] text-[14px] max-w-[204px] w-full">
            Your gateway to unforgettable journeys. Explore, discover, and travel with ease
        </div>
      </div>
      ...
      <div className="flex flex-wrap   max-w-[500px] w-full    items-center justify-between">
        ...
        <div className="flex flex-col ">
          ...
          <ul className="space-y-2 text-center text-gray-600">
            {" "}
            <li>
              <a href="#" className="hover:text-white text-[#D4D6D8] font-plusjakarta font-normal tracking-[-2%] text-[14px]  ">
                About Us
              </a>
            </li>{" "}
            <li>
      ...
      <div className="flex flex-col max-w-[162px] w-full items-start">
        {/* social Links */}
        <div className="text-white font-medium tracking-[-2%]  font-plusjakarta mb-3">Social Links</div>
